...
import (
	...
	"github.com/CyLabAcademy/challenge-orchestrator/cork/dockerfiles"
)
...
type UpdateOptions struct {
	...
	// referenced outside this cork database (e.g. another cork instance on the
	// same docker daemon that built identical content), and cork cannot see
	// those references.
	PruneOldImages bool
}
