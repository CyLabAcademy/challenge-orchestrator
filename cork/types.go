...
const (
	...
	WORKER_PING_TIMEOUT_ENV        string = "CORK_WORKER_PING_TIMEOUT"
	WORKER_DEEP_PROBE_ENV          string = "CORK_WORKER_DEEP_PROBE_INTERVAL"
	WORKER_MAX_MISSES_ENV          string = "CORK_WORKER_MAX_MISSES"
	WORKER_LOAD_MISSES_ENV         string = "CORK_WORKER_LOAD_MISSES"
	WORKER_HEALTHY_THRESHOLD_ENV   string = "CORK_WORKER_HEALTHY_THRESHOLD"
	WORKER_RECOVER_BACKOFF_ENV     string = "CORK_WORKER_RECOVER_BACKOFF"
	WORKER_RECOVER_BACKOFF_MAX_ENV string = "CORK_WORKER_RECOVER_BACKOFF_MAX"
	WORKER_EJECTION_DECAY_ENV      string = "CORK_WORKER_EJECTION_DECAY"
	WORKER_CONTROL_TIMEOUT_ENV     string = "CORK_WORKER_CONTROL_TIMEOUT"
	WORKER_TIMEOUTS_TO_EJECT_ENV   string = "CORK_WORKER_TIMEOUTS_TO_EJECT"
	WORKER_TIMEOUT_WINDOW_ENV      string = "CORK_WORKER_TIMEOUT_WINDOW"
...
type Manager struct {
	...
	// corkd; the cork CLI leaves it false so CLI-started instances always run
	// on the local daemon.
...
// containers. A challenge that sets no profile keeps cork's embedded policy.
...
type ChallengeMetadata struct {
	...
	// DeliveryType classifies what a player receives and therefore what cork
