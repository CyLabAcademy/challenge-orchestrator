...
The minimal cork setup is three servers:
...
There is no quickstart. This product is meant for deployment in production, not testing. If you're a challenge developer, please follow the readme in cmgr instead.
